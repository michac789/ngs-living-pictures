import { SingleMetaData } from "../components/MetaData/MetaData"

export const metaData: {[key: string]: SingleMetaData} = {
  'default': {
    title: 'NGS Living Pictures',
    description: 'National Gallery Singapore Living Pictures',
    name: 'National Gallery Singapore',
    type: 'website',
  },
  'cover': {
    title: 'Cover | NGS Living Pictures',
    description: 'National Gallery Singapore Living Pictures Cover',
  },
  'content': {
    title: 'Contents | NGS Living Pictures',
    description: 'National Gallery Singapore Living Pictures Contents',
  },
  'foreword': {
  ...
  'contributors': {
    title: 'Contributors | NGS Living Pictures',
    description: 'National Gallery Singapore Living Pictures Contributors',
  },
  'about': {
